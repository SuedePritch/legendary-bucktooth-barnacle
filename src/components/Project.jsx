            ...
            {projectData.map((result) => (
                <li className="project" key={result.id} >   
                    <div className="text">
                        ...
                        <a href={result.deployed} className="project-link"><svg viewBox="0 0 50 50" ><path fill="none" stroke-linecap="round" stroke-miterlimit="10" stroke-width="4" d="M33.6 1L49 1 49 16.4M26.4 23.6L48.5 1.5"/><path fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="6" d="M32,11H2c-0.6,0-1,0.4-1,1v36c0,0.6,0.4,1,1,1h36c0.6,0,1-0.4,1-1V18"/></svg></a>
                    </div>
