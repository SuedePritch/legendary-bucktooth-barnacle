...
function Resume() {
    return (
        <div className='resume-container'>
            ...
            <p>Full-stack developer with a certificate from the University of Toronto full-stack development program. Proven problem solver specializing in the MERN stack with knowledge of blockchain and web3 technologies. Life-long learner that excels at producing clean, readable, well-commented code while consistently striving to improve technical skills. Intensely curious about technology and eager to implement cutting-edge solutions.</p>  
            <h2>Technical Skills</h2>
            <p className='tech-skill-list'>JavaScript | TypeScript | React | Angular | HTML | CSS | SCSS | SASS | Scalable Vector Graphics | NodeJS | MongoDB | MySQL | Solidity | Truffle | Ganache | Remix | VSCode | Git | GitHub<br/><a href="https://bit.ly/3R8IF5q"><u>Additional Courses</u></a></p>
